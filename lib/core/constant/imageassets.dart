class AppImageAsset {
  ...
  static const String drivethruImage = "$rootImages/drivethruimage.png";
  //admin side
  static const String product = "$rootImages/product3.png";
  static const String message = "$rootImages/message.png";
  static const String notification = "$rootImages/notification.jpg";
